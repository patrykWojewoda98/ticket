...
import { TicketNotification } from "@/backend/domain/ticketNotification/ticketNotification.entity";
import { ITicketNotificationRepository } from "@/backend/domain/ticketNotification/ticketNotification.irepository";
