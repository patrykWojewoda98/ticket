...
import { TicketStatus } from "@/backend/domain/ticketStatus/ticketStatus.entity";
import { ITicketStatusRepository } from "@/backend/domain/ticketStatus/ticketStatus.irepository";
